...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (hamburger && navLinks) {
    ...
    navLinks.querySelectorAll('a').forEach(link => {
      // Don't close the mobile drawer when tapping the Login toggle —
      // it needs the drawer to stay open so its submenu is visible.
      if (link.id === 'loginToggle') return;
  ...
  if (loginToggle && loginMenu) {
    ...
    // Close dropdown when a login link is clicked
